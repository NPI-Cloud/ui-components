...
// `none` is handled separately — it hides the visual area entirely instead of mapping to a Card aspect.
export const cardBlockAspects = ['none', 'aspect169', 'aspect11', 'aspect43', 'aspect32', 'aspect34', 'line'] as const
export type CardBlockAspect = typeof cardBlockAspects[number]

const aspectMap: Record<Exclude<CardBlockAspect, 'none'>, CardAspect> = {
	aspect169: '16/9',
	aspect11: '1/1',
	aspect43: '4/3',
	aspect32: '3/2',
